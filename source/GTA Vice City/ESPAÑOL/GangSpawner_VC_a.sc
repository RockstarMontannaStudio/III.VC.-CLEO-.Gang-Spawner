...
WAIT 0
 ...
 AND IS_KEY_PRESSED VK_KEY_1
   ...
   READ_INT_FROM_INI_FILE "CLEO\GangSpawner_VC.ini" "Armas" "Cubano" weap_cuban
   READ_INT_FROM_INI_FILE "CLEO\GangSpawner_VC.ini" "Armas" "Cubano 2" weap_cuban2
...
WAIT 0
 ...
 AND IS_KEY_PRESSED VK_KEY_1
   ...
   READ_INT_FROM_INI_FILE "CLEO\GangSpawner_VC.ini" "Armas" "Haitiano" weap_haitian
   READ_INT_FROM_INI_FILE "CLEO\GangSpawner_VC.ini" "Armas" "Haitiano 2" weap_haitian2
   MARK_CHAR_AS_NO_LONGER_NEEDED haitian_char
   MARK_CHAR_AS_NO_LONGER_NEEDED haitian_char2
ENDIF
...
WAIT 0
 ...
 AND IS_KEY_PRESSED VK_KEY_1
   PRINT_HELP_STRING "Banda de Sharks"
   GET_PLAYER_COORDINATES 0 x y z
   y += 2.0
   REQUEST_MODEL SGA
   REQUEST_MODEL SGB
   ...
   READ_INT_FROM_INI_FILE "CLEO\GangSpawner_VC.ini" "Armas" "Shark" weap_shark
   READ_INT_FROM_INI_FILE "CLEO\GangSpawner_VC.ini" "Armas" "Shark 2" weap_shark2
   MARK_CHAR_AS_NO_LONGER_NEEDED shark_char
   MARK_CHAR_AS_NO_LONGER_NEEDED shark_char2
ENDIF
GOTO cubanGang
