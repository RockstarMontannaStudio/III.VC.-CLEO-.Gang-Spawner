...
WAIT 0
 ...
 AND IS_KEY_PRESSED VK_KEY_1
   PRINT_HELP_STRING "Banda de Leone"
   ...
   READ_INT_FROM_INI_FILE "CLEO\GangSpawner_III.ini" "Armas" "Leone" weap_leone
   READ_INT_FROM_INI_FILE "CLEO\GangSpawner_III.ini" "Armas" "Leone 2" weap_leone2
...
WAIT 0
 ...
 AND IS_KEY_PRESSED VK_KEY_1
   ...
   READ_INT_FROM_INI_FILE "CLEO\GangSpawner_III.ini" "Armas" "Triada" weap_triada
   READ_INT_FROM_INI_FILE "CLEO\GangSpawner_III.ini" "Armas" "Triada 2" weap_triada2
   MARK_CHAR_AS_NO_LONGER_NEEDED triada_char
   MARK_CHAR_AS_NO_LONGER_NEEDED triada_char2
ENDIF
...
WAIT 0
 ...
 AND IS_KEY_PRESSED VK_KEY_1
   ...
   READ_INT_FROM_INI_FILE "CLEO\GangSpawner_III.ini" "Armas" "Diablo" weap_diablo
   READ_INT_FROM_INI_FILE "CLEO\GangSpawner_III.ini" "Armas" "Diablo 2" weap_diablo2
   MARK_CHAR_AS_NO_LONGER_NEEDED diablo_char
   MARK_CHAR_AS_NO_LONGER_NEEDED diablo_char2
ENDIF
GOTO leoneGang 
